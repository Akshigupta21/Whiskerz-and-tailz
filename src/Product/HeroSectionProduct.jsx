...
import "./HeroSectionProduct.css";

function HeroSectionProduct() {
  return (
    <section className="hero-section">
      <div className="hero-text-container">
        <h1 className="hero-title">Everything Your Pet Needs, All in One Place</h1>
        <p className="hero-subtitle">
          Browse our extensive collection of premium pet products, from nutritious food to engaging toys and essential healthcare items.
        </p>
